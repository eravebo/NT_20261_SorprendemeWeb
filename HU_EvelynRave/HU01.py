...
df.to_csv('productos_dataset.csv', index=False, encoding='utf-8-sig', sep=';')
df.to_json('productos_dataset.json', orient='records', force_ascii=False, indent=2)

df_csv = pd.read_csv('productos_dataset.csv', encoding='utf-8-sig', sep=';')
df_json = pd.read_json('productos_dataset.json')
